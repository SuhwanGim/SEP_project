...
DrawFormattedText2([double(sprintf('<size=%d><font=-:lang=ko><color=ff0000>',fontsize)) EXP_start_text],'win',theWindow,'sx','center','sy','center','xalign','center','yalign','center');
